  ...
  return (
    <View style={s.footer} fixed>
      <Text style={s.footerText}>
        Report generated by Camelot OS | Camelot Realty Group | (212) 206-9939 | www.camelot.nyc
      </Text>
...
function ExecutiveSummaryPage({ data }: { data: ReportData }) {
  ...
  return (
    <Page size="LETTER" style={s.page}>
      <View style={s.body}>
        <SectionHead title="Executive Summary & Recommendations" subtitle="Camelot OS Analysis" />
        ...
        <View style={{ marginTop: 20, padding: 10, backgroundColor: COLORS.gray100, borderRadius: 3 }}>
          <Text style={{ fontSize: 6.5, color: COLORS.gray400, lineHeight: 1.5 }}>
            ...
            Data accuracy depends on the source agencies (HPD, DOF, DOB, ACRIS, OATH). Camelot Realty Group
