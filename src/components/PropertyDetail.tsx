      ...
      >
        ...
        <div className="bg-camelot-navy text-white px-6 py-4">
          ...
          <div className="flex items-center gap-2 mt-3">
            <button className="flex items-center gap-1.5 text-xs bg-camelot-gold text-camelot-navy px-3 py-1.5 rounded-lg font-medium hover:bg-camelot-gold-light transition-colors">
