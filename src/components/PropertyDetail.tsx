...
export default function PropertyDetail({ building, onClose, onUpdate }: PropertyDetailProps) {
  ...
  const handleReportPDF = () => {
    ...
    w.document.write(`<!DOCTYPE html><html><head><title>Scout Report — ${building.name || building.address}</title>
      ...
      <p style="font-size:11px;color:#9ca3af">Generated by Camelot Scout v6 • ${new Date().toLocaleDateString()} • Camelot Property Management Corp • 477 Madison Avenue, 6th Fl, NYC</p>
    </body></html>`);
    w.document.close();
