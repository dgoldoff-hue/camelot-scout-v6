...
function camelotOnePageSlide(d: MasterReportData): string {
  ...
  return `<div class="slide"><div class="pad" style="padding:48px 64px 46px">${logoBadge()}<div class="section-title" style="margin-bottom:18px">Camelot In One Page</div><div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px"><div class="stat-box" style="padding:14px 18px"><div class="stat-val" style="font-size:34px">41</div><div class="stat-label">Buildings</div></div><div class="stat-box" style="padding:14px 18px"><div class="stat-val" style="font-size:34px">$240M</div><div class="stat-label">AUM</div></div><div class="stat-box" style="padding:14px 18px"><div class="stat-val" style="font-size:34px">2006</div><div class="stat-label">Founded</div></div><div class="stat-box" style="padding:14px 18px"><div class="stat-val" style="font-size:34px">NYC</div><div class="stat-label">Local Team</div></div></div><div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:start"><div class="gold-card" style="min-height:328px;padding:18px 20px"><div class="sub-heading" style="font-size:20px;margin-bottom:8px">New Yorkers Servicing New Yorkers</div><p class="body-text" style="font-size:15px;line-height:1.6;margin-bottom:12px">Camelot is independent, hands-on, and built for boards that want senior attention, clean reporting, faster response, and a management partner that thinks like an owner.</p><p class="body-text" style="font-size:15px;line-height:1.6;margin-bottom:14px">We service co-ops, condos, and rental buildings across NYC, the five boroughs, Riverdale, Westchester, and New Jersey, supported by in-house accounting, legal leadership, brokerage expertise, and practical automation.</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">${proofChips.map(([label, copy]) => `<div style="border:1px solid rgba(184,151,58,.34);border-radius:8px;padding:10px 12px;background:#FAF8F5;min-height:72px"><div style="font-size:11px;color:#B8973A;font-weight:900;letter-spacing:1px;margin-bottom:4px">${label}</div><div class="small" style="line-height:1.35;color:#1a2744">${copy}</div></div>`).join('')}</div></div><div>${responseChart(d)}</div></div><div class="source-note">Sources: ${CAMELOT_OUR_TEAM_SOURCE} · ${CAMELOT_TEAM_SOURCE} · Camelot sample report package · NYC Open Data · Google Maps.</div></div></div>`;
}
